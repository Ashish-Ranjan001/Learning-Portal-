...
//       console.log("=== RAW ROLE TYPE ===", typeof roleValue);
...
//       console.log("=== FINAL ROLE ID ===", this.userRoleId);
//       console.log("=== IS ROLE ID 2? ===", this.userRoleId === 2);
//       console.log("=== IS ROLE ID 3? ===", this.userRoleId === 3);
...
//     // All other menu items are visible to everyone (including role ID 3)
