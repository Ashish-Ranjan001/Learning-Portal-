...
import { HttpClient } from "@angular/common/http"
import { UserLearningService, type CourseDetailDto1, type ModuleDto } from "../../../services/user-learning.service"
import { ModuleServicesService } from "../../../services/Module/module-services.service"
...
export class CoursemodulevideocomponentComponent implements OnInit, OnDestroy {
  courseDetail: CourseDetailDto1 | null = null
  selectedModule: ModuleDto | null = null
  courseId = ""
  userId = ""
  loading = true
  ...
  loadCourseData(): void {
    ...
    this.subscriptions.add(
      this.userLearningService.getCourseDetail1(this.courseId, this.userId).subscribe({
        next: (courseDetail) => {
          this.courseDetail = courseDetail
